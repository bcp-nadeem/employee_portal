...
<?php if($departmentdata): ?>
<?php foreach ($departmentdata as $data): ?>
<form action="<?php echo base_url('admin/AM_Controller/updateDepartmentData'); ?>" method="POST">
   <div class="card-body">
      <div class="row gy-3">
...
<?php if($departmentdata): ?>
<?php foreach ($departmentdata as $data): ?>
<form action="<?php echo base_url('admin/AM_Controller/deleteDepartmentData'); ?>" method="POST">
