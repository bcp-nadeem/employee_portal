<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <?php 
            ...
            $admin_link = 'admin/Admin_Controller/viewAssignEmployeeEvaluationDetails/'.$emp_evaluation_period->employee_evaluation_id;
        ?>
        ...
        <?php endif; ?>
            ...
            <form action="<?php echo base_url('supervisor/SV_Controller/supervisorEditAndSubmitEmployeeEvaluation/'.$emp_evaluation_period->employee_evaluation_id); ?>" method="POST">
